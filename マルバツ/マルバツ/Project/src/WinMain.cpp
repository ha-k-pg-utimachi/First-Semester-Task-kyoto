...
// グローバル変数
// ==============================
int map = STAGE_WIDTH;// 横:STAGE_WIDTH、縦:STAGE_HEIGHTのint型２次元配列 map を宣言
int map = STAGE_HEIGHT;
...
bool IsPutStone(0, 0); // bool型の戻り値、int型の引数x,yを持つIsPutStone関数を宣言
// 勝者が居るかを調べる
int // int型の戻り値を持つCheckWinner関数を宣言
